...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source:
          "/projects/:projectId/entity-definition/:entityDefId/fields/new",
      ...
      {
        source:
          "/projects/:projectId/entity-definition/:entityDefId/fields/:fieldId/edit",
      ...
      {
        source:
          "/projects/:projectId/entity-instances/:entityDefId/:instanceId/edit",
