-- =====================================================
-- Миграция для системы постов/авторов/тегов
-- =====================================================
-- Дата: 15 ноября 2025
-- Описание: Создание таблиц для блога с поддержкой
--           авторов, тегов и связи many-to-many
-- =====================================================
...
-- Чтение: доступно всем (даже без авторизации)
...
-- Чтение: доступно всем (для отображения тегов постов)
...
-- 7. Функции для работы с many-to-many фильтрами
-- =====================================================
