...
export function EntityDefinitionFormNew({
  ...
  const handleCreate = async (
    ...
    const createData = {
      ...
      type: (typeof data.type === "string" ? data.type : "primary") as
        | "primary"
        | "secondary"
        | "tertiary",
      createPermission:
        typeof data.createPermission === "string"
          ? data.createPermission
          : undefined,
      readPermission:
        typeof data.readPermission === "string"
          ? data.readPermission
          : undefined,
      updatePermission:
        typeof data.updatePermission === "string"
          ? data.updatePermission
          : undefined,
      deletePermission:
        typeof data.deletePermission === "string"
          ? data.deletePermission
          : undefined,
      titleSection0:
        typeof data.titleSection0 === "string" || data.titleSection0 === null
          ? data.titleSection0
          : null,
      titleSection1:
        typeof data.titleSection1 === "string" || data.titleSection1 === null
          ? data.titleSection1
          : null,
      titleSection2:
        typeof data.titleSection2 === "string" || data.titleSection2 === null
          ? data.titleSection2
          : null,
      titleSection3:
        typeof data.titleSection3 === "string" || data.titleSection3 === null
          ? data.titleSection3
          : null,
      enablePagination:
        typeof data.enablePagination === "boolean" ||
        data.enablePagination === null
          ? data.enablePagination
          : true,
      pageSize:
        typeof data.pageSize === "number" || data.pageSize === null
          ? data.pageSize
          : 20,
      enableFilters:
        typeof data.enableFilters === "boolean" || data.enableFilters === null
          ? data.enableFilters
          : false,
    };
    ...
    const updateData = {
      ...
      type:
        typeof data.type === "string"
          ? (data.type as "primary" | "secondary" | "tertiary")
          : undefined,
      createPermission:
        typeof data.createPermission === "string"
          ? data.createPermission
