...
import type { EntityDefinition, Field, FieldValue } from "@/lib/universal-entity/types";
...
export function FieldFormUniversal({
  ...
  const transformData = useMemo(() => {
    return (formData: Record<string, FieldValue>): Record<string, FieldValue> => {
  ...
  const handleCreate = async (data: Record<string, FieldValue>): Promise<Field> => {
    return createFieldFromClient({
      ...
      relationFieldName: typeof data.relationFieldName === "string" || data.relationFieldName === null ? data.relationFieldName : null,
      relationFieldLabel: typeof data.relationFieldLabel === "string" || data.relationFieldLabel === null ? data.relationFieldLabel : null,
      relationFieldRequired: typeof data.relationFieldRequired === "boolean" ? data.relationFieldRequired : Boolean(data.relationFieldRequired ?? false),
      relationFieldRequiredText: typeof data.relationFieldRequiredText === "string" || data.relationFieldRequiredText === null ? data.relationFieldRequiredText : null,
  ...
  const handleUpdate = async (
    ...
    return updateFieldFromClient(id, {
      ...
      placeholder: typeof data.placeholder === "string" || data.placeholder === null ? data.placeholder : undefined,
